...
class ParticipanteController {
    ...
    public function listarByCodSorteo() {
        ...
        $finalizado = $sorteo->getById($cod_sorteo)->getFinalizado();
        ...
        $this->view->show("participanteListarSorteoView.php", $data);
    }
    ...
    public function sortear() {
        ...
        $data['items'] = $listado;
        $data['cod_sorteo'] = $cod_sorteo;
        $data['finalizado'] = $sorteo_finalizado;
    ...
    public function nuevo() {
        ...
        $this->view->show("participanteNuevoSorteoView.php", array('errores' => $errores, 'cod_sorteo' => $_REQUEST['cod_sorteo']));
    ...
    public function editar() {
        ...
        if (isset($_REQUEST['submit'])) {
            ...
            if (empty($errores)) {
                ...
                // CORRECCIÓN: Redirigir a la lista de participantes usando el código del sorteo del item
        ...
        // Si no se ha pulsado el botón de actualizar se carga la vista para editar el item
         $this->view->show("participanteEditarView.php", array('errores' => $errores, 'item' => $item));
